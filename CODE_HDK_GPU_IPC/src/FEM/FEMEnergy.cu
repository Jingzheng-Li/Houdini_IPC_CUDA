...
namespace FEMENERGY {
    ...
    void computeXTilta(std::unique_ptr<GeometryManager>& instance, const double& rate) {
        ...
        _computeXTilta << <blockNum, threadNum >> > (instance->cudaBoundaryType, instance->cudaTetVel, instance->cudaOriginTetPos, instance->cudaXTilta, instance->IPC_dt, rate, numbers);
    }
