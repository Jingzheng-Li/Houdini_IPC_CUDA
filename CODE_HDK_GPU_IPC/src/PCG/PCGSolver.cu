...
namespace PCGSOLVER {
    ...
    double My_PCG_add_Reduction_Algorithm(int type, std::unique_ptr<GeometryManager>& instance, PCGData* pcg_data, int vertexNum, double alpha = 1) {
    ...
    void Solve_PCG_AX_B(const std::unique_ptr<GeometryManager>& instance, const double3* c, double3* q, const BHessian& BH, int vertNum) {
        int numbers = vertNum;
        const unsigned int threadNum = default_threads;
        int blockNum = (numbers + threadNum - 1) / threadNum;
    ...
    void Solve_PCG_AX_B2(const std::unique_ptr<GeometryManager>& instance, const double3* c, double3* q, const BHessian& BH, int vertNum) {
        int numbers = vertNum;
        const unsigned int threadNum = default_threads;
        int blockNum = (numbers + threadNum - 1) / threadNum;
        __PCG_Solve_AX_mass_b << <blockNum, threadNum >> > (instance->cudaTetMass, c, q, numbers);
    ...
    void construct_P(const std::unique_ptr<GeometryManager>& instance, MATHUTILS::Matrix3x3d* P, const BHessian& BH, int vertNum) {
        int numbers = vertNum;
        const unsigned int threadNum = default_threads;
        int blockNum = (numbers + threadNum - 1) / threadNum;
    ...
    void construct_P2(const std::unique_ptr<GeometryManager>& instance, MATHUTILS::Matrix3x3d* P, const BHessian& BH, int vertNum) {
        int numbers = vertNum;
        const unsigned int threadNum = default_threads;
        int blockNum = (numbers + threadNum - 1) / threadNum;
        __PCG_mass_P << <blockNum, threadNum >> > (instance->cudaTetMass, P, numbers);
