...
namespace IPCFRICTION {
    ...
    __device__ __host__ void computeTangentBasis_PT(
        ...
        double3 v12 = MATHUTILS::__minus(v2, v1);
        double3 v12_normalized = MATHUTILS::__normalized(v12);
        double3 c = MATHUTILS::__normalized(MATHUTILS::__v_vec_cross(MATHUTILS::__v_vec_cross(v12, MATHUTILS::__minus(v3, v1)), v12));
    ...
    __device__ __host__ void computeClosestPoint_PT(
        ...
        MATHUTILS::Matrix3x2d basis;
        double3 v12 = MATHUTILS::__minus(v2, v1);
        double3 v13 = MATHUTILS::__minus(v3, v1);
        basis.m[0][0] = v12.x;
        basis.m[1][0] = v12.y;
        basis.m[2][0] = v12.z;
        ...
        basis.m[1][1] = v13.y;
        basis.m[2][1] = v13.z;
        MATHUTILS::Matrix2x2d btb = __M3x2_transpose_self__multiply(basis);
        //Eigen::Matrix<double, 2, 3> basis;
        //basis.row(0) = v2 - v1;
        //basis.row(1) = v3 - v1;
        MATHUTILS::Matrix2x2d b2b_inv;
        __Inverse2x2(btb, b2b_inv);
        double3 v10 = MATHUTILS::__minus(v0, v1);
    ...
    __device__ __host__ __device__ __host__ void computeRelDX_PT(
        ...
        double3& relDX) {
        double3 b1_dx12 = MATHUTILS::__s_vec_multiply(MATHUTILS::__minus(dx2, dx1), beta1);
        double3 b2_dx13 = MATHUTILS::__s_vec_multiply(MATHUTILS::__minus(dx3, dx1), beta2);

        relDX = MATHUTILS::__minus(dx0, MATHUTILS::__add(MATHUTILS::__add(b1_dx12, b2_dx13), dx1));
    }
    ...
    __device__ __host__ void computeTangentBasis_EE(
        ...
        const double3& v3,
        MATHUTILS::Matrix3x2d& basis) {
        double3 v01 = MATHUTILS::__minus(v1, v0);
        double3 v01_normalized = MATHUTILS::__normalized(v01);
        double3 c = MATHUTILS::__normalized(MATHUTILS::__v_vec_cross(MATHUTILS::__v_vec_cross(v01, MATHUTILS::__minus(v3, v2)), v01));
    ...
    __device__ __host__ void computeClosestPoint_EE(
        ...
        const double3& v3,
        double2& gamma) {
        double3 e20 = MATHUTILS::__minus(v0, v2);
        double3 e01 = MATHUTILS::__minus(v1, v0);
        double3 e23 = MATHUTILS::__minus(v3, v2);
        MATHUTILS::Matrix2x2d coefMtr;
        coefMtr.m[0][0] = MATHUTILS::__squaredNorm(e01);
        coefMtr.m[0][1] = -MATHUTILS::__v_vec_dot(e23, e01);
        coefMtr.m[1][0] = -MATHUTILS::__v_vec_dot(e23, e01);
        coefMtr.m[1][1] = MATHUTILS::__squaredNorm(e23);

        double2 rhs;
        rhs.x = -MATHUTILS::__v_vec_dot(e20, e01);
        rhs.y = MATHUTILS::__v_vec_dot(e20, e23);
        MATHUTILS::Matrix2x2d coefMtr_inv;
    ...
    __device__ __host__ void computeRelDX_EE(
        ...
        double3& relDX) {
        double3 g1_dx01 = MATHUTILS::__s_vec_multiply(MATHUTILS::__minus(dx1, dx0), gamma1);
        double3 g2_dx23 = MATHUTILS::__s_vec_multiply(MATHUTILS::__minus(dx3, dx2), gamma2);

        relDX = MATHUTILS::__minus(MATHUTILS::__add(dx0, g1_dx01), MATHUTILS::__add(dx2, g2_dx23));
    }
    ...
    __device__ __host__ void computeTangentBasis_PE(
        ...
        double3 v12 = MATHUTILS::__minus(v2, v1);
        double3 v12_normalized = MATHUTILS::__normalized(v12);
        double3 c = MATHUTILS::__normalized(MATHUTILS::__v_vec_cross(v12, MATHUTILS::__minus(v0, v1)));
        basis.m[0][0] = v12_normalized.x;
        basis.m[1][0] = v12_normalized.y;
        basis.m[2][0] = v12_normalized.z;
        basis.m[0][1] = c.x;
    ...
    __device__ __host__ void computeClosestPoint_PE(
        ...
        const double3& v2,
        double& yita) {
        double3 e12 = MATHUTILS::__minus(v2, v1);
        yita = MATHUTILS::__v_vec_dot(MATHUTILS::__minus(v0, v1), e12) / MATHUTILS::__squaredNorm(e12);
    }
    __device__ __host__ void computeRelDX_PE(
        ...
        double3 y_dx12 = MATHUTILS::__s_vec_multiply(MATHUTILS::__minus(dx2, dx1), yita);

        relDX = MATHUTILS::__minus(dx0, MATHUTILS::__add(dx1, y_dx12));
    }
    ...
    __device__ __host__ void computeTangentBasis_PP(
        ...
        if (MATHUTILS::__squaredNorm(xCross) > MATHUTILS::__squaredNorm(yCross)) {
            double3 xCross_n = MATHUTILS::__normalized(xCross);
            double3 c = MATHUTILS::__normalized(MATHUTILS::__v_vec_cross(v01, xCross));
            ...
            double3 yCross_n = MATHUTILS::__normalized(yCross);
            double3 c = MATHUTILS::__normalized(MATHUTILS::__v_vec_cross(v01, yCross));
    ...
    __device__ __host__ void computeRelDX_PP(
        ...
        const double3& dx1,
        double3& relDX) {
        relDX = MATHUTILS::__minus(dx0, dx1);
    }
